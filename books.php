  ...
  <div class="wrapper">
      ...
      <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="dark">
          <a href="dashboard.php" class="logo">
            <img src="assets/img/kaiadmin/logo-light-n.png" alt="navbar brand" class="navbar-brand" height="35" />
          </a>
        ...
        <div class="sidebar-content">
          <ul class="nav nav-secondary">
            ...
            <li class="nav-item active">
              <a href="books.php" class="collapsed" aria-expanded="false">
                <i class="fas fa-book"></i>
                <p>Books</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="categories.php" class="collapsed" aria-expanded="false">
                <i class="fas fa-th-list"></i>
                <p>Categories</p>
              </a>
            </li>
            <li class="" style="margin-top:450px; margin-left:30px;">
              <a href="logout.php" class="btn btn-sm btn-danger" aria-expanded="false"
    ...
    <div class="main-panel">
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                              ...
                              <form method="POST" action="add_book.php">
                                <div class="row">
                                  ...
                                  <div class="col-md-6 pe-0">
                                    <div class="form-group form-group-default">
                                      <label>Author</label>
                                      <input id="addPosition" type="text" class="form-control" placeholder="fill author"
                                        name="author" />
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      ...
                                      <input id="addRelease" type="text" class="form-control"
                                        placeholder="fill release year" name="release" />
                                    </div>
                                  </div>
                                  <div class="col-md-6 pe-0">
                                    <div class="form-group form-group-default">
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                      <label>Rack</label>
                                      <input id="addRack" type="text" class="form-control" placeholder="fill rack"
                                        name="rack" />
                                    </div>
                                  </div>
                                  <div class="col-md-6 pe-0">
                                    <div class="form-group form-group-default">
                                      ...
                                      <select name="description" id="descriptionFilter" class="form-select">
                            ...
                            <div class="modal-footer border-0">
                              <button id="addRowButton" class="btn btn-primary" type="submit">
                                Add
                              </button>
                              </form>
                              ...
                              <tr>
                                ...
                                <td>
                                  <div class="form-button-action">
                                    <button type="button" data-bs-toggle="modal" title=""
                                      class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"
                                      data-bs-target="#updateModal<?php echo $row['book_id'] ?>">
                                      <i class="fa fa-edit"></i>
                                    </button>
                                    <button type="button" data-bs-toggle="modal" title="" class="btn btn-link btn-danger"
                                      data-original-title="Remove"
                                      data-bs-target="#deleteModal<?php echo $row['book_id'] ?>">
                                      <i class="fa fa-times"></i>
                                    </button>
                                    <button type="button" data-bs-toggle="modal" title=""
                                      class="btn btn-link btn-success btn-lg" data-original-title="Upload File"
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        <div class="modal fade" id="uploadModal<?php echo $row['book_id'] ?>" tabindex="-1"
        ...
        <!-- Edit Modal -->
        <div class="modal fade" id="updateModal<?php echo $row['book_id'] ?>" tabindex="-1" role="dialog"
          aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header border-0">
                ...
                <form method="POST" action="update_book.php">
                  <div class="row">
                    <div class="col-sm-12">
                      ...
                      <div class="form-group form-group-default">
                        <label>Title</label>
                        <input id="addName" type="text" class="form-control" placeholder="fill title" name="title"
                    ...
                    <div class="col-md-6 pe-0">
                      <div class="form-group form-group-default">
                        <label>Author</label>
                        <input id="addPosition" type="text" class="form-control" placeholder="fill author" name="author"
                    ...
                    <div class="col-md-6">
                      <div class="form-group form-group-default">
                        <label>Release Year</label>
                        <input id="addOffice" type="text" class="form-control" placeholder="fill release year"
                          name="release" value="<?php echo $row['release'] ?>" />
                      </div>
                    </div>
                    <div class="col-md-6 pe-0">
                      <div class="form-group form-group-default">
                    ...
                    <div class="col-md-6">
                      <div class="form-group form-group-default">
                        <label>Rack</label>
                        <input id="addOffice" type="text" class="form-control" placeholder="fill rack" name="rack"
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="deleteModal<?php echo $row['book_id'] ?>" tabindex="-1" role="dialog"
          aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header border-0">
