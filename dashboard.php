...
// Fungsi untuk menghitung total dari tabel
function countTotal($conn, $table, $condition = '')
{
...
$totalAdmin = countTotal($koneksi, 'users');

// Menghitung total books
$totalBooks = countTotal($koneksi, 'books');
        ...
        <div class="page-inner">
          <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
            <div>
              ...
              <h6 class="op-7 mb-2">Hallo <?php echo $sesName; ?>, selamat datang!</h6>
            </div>
          </div>
          <div class="row">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?php echo $totalAdmin; ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col col-stats ms-3 ms-sm-0">
                      <div class="numbers">
                        ...
                        <h4 class="card-title"><?php echo $totalBooks; ?></h4>
                      </div>
                    </div>
                  </div>
                </div>
