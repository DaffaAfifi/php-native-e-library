      ...
      <div class="main-panel">
        ...
        <div class="container">
          <div class="page-inner">
            ...
            >
              <div>
                <h3 class="fw-bold mb-3">Racks</h3>
                <h6 class="op-7 mb-2">Kelola semua rakmu!</h6>
              </div>
            </div>
            <div class="container">
              <div class="page-inner">        
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <form method="POST" action="add_rack.php">
                                  <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <td>
                                  <div class="form-button-action">
                                    <button
                                      ...
                                      data-bs-target="#updateModal<?php echo $rackID; ?>"
                                    >
                                    ...
                                    <button
                                      ...
                                      data-bs-target="#deleteModal<?php echo $rackID; ?>"
                                    >
        ...
        <div
          class="modal fade"
          id="updateModal<?php echo $rackID; ?>"
          tabindex="-1"
          role="dialog"
          aria-hidden="true"
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form method="POST" action="update_rack.php">
                  <div class="row">
                    <div class="col-sm-12">
                      <div class="form-group form-group-default">
                        <label>Rack Code</label>
        ...
        <div
          class="modal fade"
          id="deleteModal<?php echo $rackID; ?>"
          tabindex="-1"
          role="dialog"
          aria-hidden="true"
        >
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer border-0">
              <form method="POST" action="delete_rack.php">
                <input type="hidden" name="rack_id" value="<?php echo $rackID; ?>">
                <button
                  id="addRowButton"
                  class="btn btn-primary"
